...
Write the minimum code that solves the stated problem _now_.
...
- Remove only the imports / variables / functions that _your_ changes made unused
...
When fixing bugs: write the failing test first, watch it fail, _then_ fix.
...
Never paper over an unexpected null / undefined with a defensive check — find out _why_ it is null.
...
Say what you did and _why_, not just the diff.
...
- Clarifying questions and assumption statements appear _before_ implementation
